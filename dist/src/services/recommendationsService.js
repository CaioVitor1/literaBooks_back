...
function getRecommendations(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const lookFirstRecommendations = yield recommendationsRepository.findRecommendations(genre1);
        const lookSecondRecommendations = yield recommendationsRepository.findRecommendations(genre2);
        const lookThirtRecommendations = yield recommendationsRepository.findRecommendations(genre3);
